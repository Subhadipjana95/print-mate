export function AppFooter() {
  return (
    <footer className="md:border-t border-white/6 md:mt-2 pb-8 pt-2 md:pt-8">
      <div className="relative max-w-5xl mx-auto px-6 flex items-center justify-between text-xs text-zinc-600 group">
        <span>© {new Date().getFullYear()} PrintSyte. <span className="hidden md:inline-block">All rights reserved.</span></span>
